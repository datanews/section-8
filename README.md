...
* `2000master.csv` and `2000master.geojson` (with census tract geographies) combines the 2000, 2004, 2005, 2006, 2007, 2008, 2009, 2010 and 2011 HUD data for Housing Choice Voucher households by 2000 census tract IDs. Neighborhood Tabulation Area codes and names are also included for each census tract. 
* `2010master.csv` and `2010master.geojson` (with census tract geographies) combines the 2012, 2013, 2014 and 2015 HUD data for Housing Choice Voucher households by 2010 census tract IDs. Neighborhood Tabulation Area codes and names are also included for each census tract.
...
New York City Housing Authority (NYCHA) - Year End data for 2000, 2006, 2007, 2009, 2010, 2011, 2013, 2014 and 2015
*`NYCHA_2000.xlsx`- `STCTYTRT_2000` is the 2000 census tract ID, `Frequency` is the number of voucher households
